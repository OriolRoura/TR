...
void loop() {
 ...
 if(pass == true){
  ...
  pla.add(millis(),normGyro.XAxis,normGyro.YAxis,normGyro.ZAxis,normAccel.XAxis,normAccel.YAxis,normAccel.ZAxis);

  pla.mean(&retgd);


//  retgd.set(millis(),normGyro.XAxis,normGyro.YAxis,normGyro.ZAxis,normAccel.XAxis,normAccel.YAxis,normAccel.ZAxis);

dataString = String (retgd.getTimeData())+";"+String(retgd.getGyroX())+";"+String(retgd.getGyroY())+";"+String(retgd.getGyroZ())+";";
dataString += String(retgd.getAccelX())+";"+String(retgd.getAccelY())+";"+String(retgd.getAccelZ());
